<?php
use App\Http\Controllers\PubHostController;
...
//     // Log::debug(dump($route));
//     // $name = Route::currentRouteName(); // string
//     // Log::debug(dump($name));
//     // $action = Route::currentRouteAction(); // string
//     // Log::debug(dump($action));
// })->where('any', '.*');
...
Route::get('/serpubhost', [PubHostController::class, 'index'])->name('pubhost-page');
