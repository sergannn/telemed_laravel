...
@role('doctor')
    ...
    @can('manage_transactions')
        <li class="d-none nav-item {{ Request::is('doctors/transactions*') ? 'active' : '' }}">
            <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('doctors.transactions') }}">
                ...
                <span class="aside-menu-title">aa{{ __('messages.transactions') }}</span>
            </a>
        </li>
    @endcan
    <li
    ...
    @can('manage_patient_visits')
        <li class="d-none nav-item {{ Request::is('doctors/visits*') ? 'active' : '' }}">
    ...
    @endcan
    <li class="d-none nav-item {{ Request::is('doctors/live-consultations*') ? 'active' : '' }}">
    ...
    <li class="d-none nav-item {{ Request::is('doctors/connect-google-calendar*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
    ...
    <li class="d-none nav-item {{ Request::is('doctors/holidays*') ? 'active' : '' }}">
...
@if (isRole('doctor'))
    <li
        class="d-none nav-item {{ Request::is('doctors/smart-patient-cards*', 'doctors/generate-patient-smart-cards*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
