            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="row mb-6">
                        <label class="col-lg-4 form-label">
                            <span>{{__('messages.setting.currency')}}:</span>
                        </label>
                ...
                <div class="row">
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            {{ Form::select('language', $languages, $courentlanguage, [
                                    'class' => 'form-select', 'aria-label'=>"Select a Currency",
                                    'data-control'=>'select2','placeholder' =>__('messages.select_language'),'required']) }}
                        </div>
                ...
                <div class="row mb-6">
                    <label class="col-lg-4 form-label">
                        <span>{{__('messages.common.google_recaptcha')}}:</span>
                    </label>
                    <div class="col-lg-8">
                        <div class="form-check form-check-solid form-switch">
                            <input name="recaptcha" {{$setting['recaptcha'] == 1 ? 'checked' : ''}} value="1" class="form-check-input settingrecaptcha" type="checkbox" id="settingrecaptcha">
                        </div>
                    </div>
                </div>

                <div class="recaptcha-field" style="display: {{$setting['recaptcha'] == 1 ? '' : 'none'}}">
                    <div class="row mb-6">
                        {{ Form::label('email',__('messages.common.google_captcha_key').':',['class'=>'col-lg-4 form-label']) }}
                        <div class="col-lg-8">
                            {{ Form::text('googleCaptchaKey', $setting['googleCaptchaKey'], ['class' => 'form-control google-captcha-key','placeholder'=>'Google Captcha Key:']) }}
                        </div>
                    </div>
                    <div class="row mb-6">
                        {{ Form::label('email',__('messages.common.google_captcha_secret').':',['class'=>'col-lg-4 form-label ']) }}
                        <div class="col-lg-8">
                            {{ Form::text('googleCaptchaSecret', $setting['googleCaptchaSecret'], ['class' => 'form-control google-captcha-secret','placeholder'=>'Google Captcha Secret:','']) }}
                        </div>
                    </div>
                </div>
