...
class User extends Authenticatable implements HasMedia, HasApiTokens, MustVerifyEmail
{
    use HasApiTokensTrait, HasFactory, Notifiable, InteractsWithMedia, HasRoles, Impersonate;
